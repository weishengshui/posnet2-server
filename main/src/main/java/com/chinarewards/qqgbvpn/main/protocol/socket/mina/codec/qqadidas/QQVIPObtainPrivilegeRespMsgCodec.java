...
public class QQVIPObtainPrivilegeRespMsgCodec implements ICommandCodec {
	...
	public ICommand decode(IoBuffer in, Charset charset)
		...
		log.debug("QQVIPObtainPrivilegeRespMsgCodec decode begin!");
		...
		QQVIPObtainPrivilegeRespMsg msg = new QQVIPObtainPrivilegeRespMsg(
				result, xactTime, title, tip);

		log.debug("QQVIPObtainPrivilegeRespMsgCodec decode end, msg:{}", msg);
		return msg;
	}

	@Override
	public byte[] encode(ICommand bodyMessage, Charset charset) {
		log.debug("QQVIPObtainPrivilegeRespMsgCodec encode begin!");
		QQVIPObtainPrivilegeRespMsg responseMessage = (QQVIPObtainPrivilegeRespMsg) bodyMessage;
		...
		log.debug(
				"QQVIPObtainPrivilegeRespMsgCodec encode end, result byte size:{}",
				resultByte.length);
